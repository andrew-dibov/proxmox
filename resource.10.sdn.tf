resource "proxmox_sdn_zone_vlan" "sdn__tnnt10" {
  ...
  depends_on = [proxmox_sdn_applier.sdn__tnnt10_finalizer]
}
...
resource "proxmox_sdn_applier" "sdn__tnnt10_applier" {
  lifecycle {
...
resource "proxmox_sdn_applier" "sdn__tnnt10_finalizer" {
}
